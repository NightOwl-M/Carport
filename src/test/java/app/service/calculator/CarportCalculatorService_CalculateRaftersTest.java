...
public class CarportCalculatorService_CalculateRaftersTest {
    ...
    void calculateRafters() throws DatabaseException {
        //Arrange
        Order order = new Order(3, 3, 510, 780, "Plasttrapezplader", "Ønsker det i sort", "Tak for snakken", 3, 25000, Timestamp.valueOf("2025-05-08 12:30:15"));
        CarportCalculatorService calc = new CarportCalculatorService(780, 510, connectionPool);
        ...
        //Antallet af moduler med 1 spær i hver beregnes:
        775.5 / (4.5 + 55) = 13.03 ~ 14 moduler

        //Ende-spærret ligges til:
        14 + 1 = 15 spær ialt

        //Carportens bredde er 510, dvs materialevariant med Id 6 (540cm) er det nærmeste spær der er langt nok
         */

        Material rafter = new Material(11, "45x195 mm. spærtræ ubh.", "stk", 37);

        MaterialVariant raftVariant540 = new MaterialVariant(6, 540, rafter);

        Component componentRaftVariant360 = new Component(3, 15, "Spær, monteres på rem", raftVariant540);

        expectedOrderComponents.add(componentRaftVariant360);


        //Act
        calc.calculateRafters(order);
        ...
        assertNotEquals(10, actualOrderComponents.get(0).getQuantity());
        assertNotEquals(600, actualOrderComponents.get(0).getMaterialVariant().getLength());
    }
}
